...
template_path = (
    "C:/Users/fabio.picoli/Documents/adp/templates/ala_marketplace/post/transform"
)
...
print(
    f'=> Objective: Change "{old_text}" to "{new_text}" from files inside folder "{template_path}"\n'
)
print("processing...")
